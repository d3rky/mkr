...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Mar 21 21:14:24 2013
# Project:  mkr.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mkr_qt1.0.0/ && $(COPY_FILE) --parents include/AbstractBoundaryCondition.h include/Boundary.h include/DerichleBoundaryCondition.h include/GaussSeidel.h include/MkrPoint.h include/NeumanBoundaryCondition.h include/Plate.h include/PlateDiscret.h include/Solver.h include/Utils.h .tmp/mkr_qt1.0.0/ && $(COPY_FILE) --parents src/describe_task.cpp src/main_qt.cpp src/boundary_conditions/DerichleBoundaryCondition.cpp src/boundary_conditions/NeumanBoundaryCondition.cpp src/plate/mkrpoint.cpp src/plate/plate.cpp src/plate/plate_discret.cpp src/solver/gauss_seidel.cpp src/utils/boundary.cpp src/utils/utils.cpp src/utils/console/solve_task.cpp .tmp/mkr_qt1.0.0/ && (cd `dirname .tmp/mkr_qt1.0.0` && $(TAR) mkr_qt1.0.0.tar mkr_qt1.0.0 && $(COMPRESS) mkr_qt1.0.0.tar) && $(MOVE) `dirname .tmp/mkr_qt1.0.0`/mkr_qt1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mkr_qt1.0.0
